        ...
        <div>
            ...
            <div className='container mx-auto px-4 py-8'>
                ...
                <section className='mb-8 border-t border-gray-300 pt-8'>
                    ...
                    <ul className='justify list-inside list-disc space-y-2 text-gray-600'>
                        <li>
                            <strong>Accès et Abonnements :</strong> Gratuit :
                            Accès aux services avec publicités et boost
                            d'article payant (2€). Premium (4,99€/mois) : Pas de
                            publicités, 3 boosts gratuits par mois, accès
                            exclusif de 3 jours aux nouveaux articles, et accès
                            au mode d'échange "one-to-many" après 3 échanges
                            réussis.
                        </li>
                        <li>
                            <strong>Limites d'Utilisation :</strong> Maximum de
                            5 articles publiés simultanément par utilisateur.
                            Valeur maximale de la besace : 200€ (150€ pour les
                            non-premium). Annonces renouvelables tous les 6
                            mois.
                        </li>
                        <li>
                            <strong>Sécurité des Echanges :</strong> Évaluations
                            après chaque échange pour assurer la fiabilité des
                            profils. Contestation possible sous 5 jours si un
                            objet reçu est non conforme, avec remboursement en
                            cas de validation. Mode "one-to-many" : limité à 75%
                            de la valeur de la besace après 3 échanges réussis.
                        </li>
                        <li>
                            <strong>Résiliation et Sanctions :</strong> En cas
                            d'arrêt de l'abonnement Premium, règlement des
                            montants dus obligatoire. Suspension temporaire ou
                            définitive en cas de non-respect des CGU.
                        </li>
                        <li>
                            <strong>Données et Responsabilité :</strong> Respect
                            des données personnelles selon notre Politique de
                            Confidentialité. La Plateforme agit comme
                            intermédiaire, les échanges s'effectuent sous la
